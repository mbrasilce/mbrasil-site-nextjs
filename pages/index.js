  ...
  return (
    <div className="container">
      ...
      <div className="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        ...
        <p className="lead">
          Se estava a buscar um desenvolvedor web, sua procura acabou. Sites
          profissionais, rápidos, simples e baratos.
        </p>
      </div>
      ...
      <div className="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        ...
        <p className="lead">
          Alojamento profissional com suporte integrado e personalizado.
          Registro de domínios e configuração de emails e sites.
        </p>
      </div>
